...
class InspectorGeneratorCommand {
	...
	private const INSPECTOR_NAMESPACE = 'WMDE\Fundraising\PaymentContext\Tests\Fixtures';
	...
	private const INSPECTORS = [
		'WMDE\Fundraising\PaymentContext\Domain\Model\CreditCardPayment' => 'CreditCardPaymentSpy',
		'WMDE\Fundraising\PaymentContext\Domain\Model\PayPalPayment' => 'PayPalPaymentSpy'
	];
